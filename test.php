...
{
    $result = startGame('dn22binezhsvvcpyztjwme3b9p0ngc9slbp71nw3zyf1mv78e4sh923x83fwq44t');
    echo $result;
}
...
function testCheckCallBetRaise()
{
    $result = checkOrCall('mco718iutl8gn776ufflioqnl0e3vhejw2sn4wrvdousbdqdd7mwfx0q85czaci2');
    println($result);
    $result = betOrRaise('hgvk6uk002z301ecmtzj9v1a0h57nn0n5cy5mi2c1r5y748ejion2kx1lshqop45', 300);
    println($result);
    $result = checkOrCall('yus0936p4xbc9gpdmy28bp8e1sgez4qtsgbzewdj492pkauab06pjevkw17fn4t4');
    println($result);
...
function testUpdate()
{
    $authenticationId = "mco718iutl8gn776ufflioqnl0e3vhejw2sn4wrvdousbdqdd7mwfx0q85czaci2";
    echo getUpdate($authenticationId);
}

function testGetCards()
{
    $authenticationId = 'mco718iutl8gn776ufflioqnl0e3vhejw2sn4wrvdousbdqdd7mwfx0q85czaci2';
    echo getCards($authenticationId);
}

function testSessionExisting()
{
    $globalId = 'asdf';
